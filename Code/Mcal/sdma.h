...
#define DMAC_CHX_CTL_SMS(n)		((n & 0x1)<<0)
#define DMAC_CHX_CTL_DMS(n)		((n & 0x1)<<2)
#define DMAC_CHX_CTL_SRC_INC	(0<<4)
#define DMAC_CHX_CTL_SRC_FIX	(1<<4)
#define DMAC_CHX_CTL_DST_INC	(0<<6)
#define DMAC_CHX_CTL_DST_FIX	(1<<6)
#define DMAC_CHX_CTL_SRC_WIDTH(n)	((n & 0x7)<<8)
#define DMAC_CHX_CTL_DST_WIDTH(n)	((n & 0x7)<<11)
...
#define DMAC_CHX_CFG_SRC_MULTBLK_TYPE_MASK	(0x3ull<<DMAC_CHX_CFG_SRC_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_SRC_MULTBLK_TYPE_CONT	(0)
#define DMAC_CHX_CFG_SRC_MULTBLK_TYPE_RELD	(0x1ull<<DMAC_CHX_CFG_SRC_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_SRC_MULTBLK_TYPE_SHDW	(0x2ull<<DMAC_CHX_CFG_SRC_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_SRC_MULTBLK_TYPE_LLST	(0x3ull<<DMAC_CHX_CFG_SRC_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_DST_MULTBLK_TYPE_POS	(2)
#define DMAC_CHX_CFG_DST_MULTBLK_TYPE_MASK	(0x3ull<<DMAC_CHX_CFG_DST_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_DST_MULTBLK_TYPE_CONT	(0)
#define DMAC_CHX_CFG_DST_MULTBLK_TYPE_RELD	(0x1ull<<DMAC_CHX_CFG_DST_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_DST_MULTBLK_TYPE_SHDW	(0x2ull<<DMAC_CHX_CFG_DST_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_DST_MULTBLK_TYPE_LLST	(0x3ull<<DMAC_CHX_CFG_DST_MULTBLK_TYPE_POS)
#define DMAC_CHX_CFG_TT_FC_POS		(32)
#define DMAC_CHX_CFG_TT_FC_MASK		(0x7ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_M2M		(0)
#define DMAC_CHX_CFG_TT_FC_M2P		(0x1ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_P2M		(0x2ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_P2P		(0x3ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_P2M_SRC	(0x4ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_P2P_SRC	(0x5ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_M2P_DST	(0x6ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_TT_FC_P2P_DST	(0x7ull<<DMAC_CHX_CFG_TT_FC_POS)
#define DMAC_CHX_CFG_HS_SEL_SRC_SW	(1ull<<35)
#define DMAC_CHX_CFG_HS_SEL_DST_SW	(1ull<<36)
#define DMAC_CHX_CFG_SRC_HW_HSPOL_LOW	(1ull<<37)
#define DMAC_CHX_CFG_DST_HW_HSPOL_LOW	(1ull<<38)
#define DMAC_CHX_CFG_SRC_PER	(1ull<<39)
#define DMAC_CHX_CFG_DST_PER	(1ull<<44)
#define DMAC_CHX_CFG_CH_PRIOR_POS	(49)
#define DMAC_CHX_CFG_CH_PRIOR_MASK	(0x7ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_0		(0)
#define DMAC_CHX_CFG_CH_PRIOR_1		(0x1ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_2		(0x2ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_3		(0x3ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_4		(0x4ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_5		(0x5ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_6		(0x6ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
#define DMAC_CHX_CFG_CH_PRIOR_7		(0x7ull<<DMAC_CHX_CFG_CH_PRIOR_POS)
...
#define DMAC_CHX_INTSTATUS_ENABLEREG_BLOCK_TFR_DONE_EN	(1ull<<0)
#define DMAC_CHX_INTSTATUS_ENABLEREG_DMA_TFR_DONE_EN	(1ull<<1)
#define DMAC_CHX_INTSTATUS_ENABLEREG_SRC_TRANSCOMP_EN	(1ull<<3)
#define DMAC_CHX_INTSTATUS_ENABLEREG_DST_TRANSCOMP_EN	(1ull<<4)
#define DMAC_CHX_INTSTATUS_ENABLEREG_SRC_DEC_ERR_EN		(1ull<<5)
#define DMAC_CHX_INTSTATUS_ENABLEREG_DST_DEC_ERR_EN		(1ull<<6)
#define DMAC_CHX_INTSTATUS_ENABLEREG_SRC_SLV_ERR_EN		(1ull<<7)
#define DMAC_CHX_INTSTATUS_ENABLEREG_DST_SLV_ERR_EN		(1ull<<8)
#define DMAC_CHX_INTSTATUS_ENABLEREG_LLI_RD_DEC_ERR_EN	(1ull<<9)
#define DMAC_CHX_INTSTATUS_ENABLEREG_LLI_WR_DEC_ERR_EN	(1ull<<10)
#define DMAC_CHX_INTSTATUS_ENABLEREG_LLI_RD_SLV_ERR_EN	(1ull<<11)
#define DMAC_CHX_INTSTATUS_ENABLEREG_LLI_WR_SLV_ERR_EN	(1ull<<12)
#define DMAC_CHX_INTSTATUS_BLOCK_TFR_DONE	(1ull<<0)
#define DMAC_CHX_INTSTATUS_DMA_TFR_DONE		(1ull<<1)
#define DMAC_CHX_INTSTATUS_SRC_TRANSCOMP	(1ull<<3)
#define DMAC_CHX_INTSTATUS_DST_TRANSCOMP	(1ull<<4)
#define DMAC_CHX_INTSTATUS_SRC_DEC_ERR		(1ull<<5)
#define DMAC_CHX_INTSTATUS_DST_DEC_ERR		(1ull<<6)
#define DMAC_CHX_INTSTATUS_SRC_SLV_ERR		(1ull<<7)
#define DMAC_CHX_INTSTATUS_DST_SLV_ERR		(1ull<<8)
#define DMAC_CHX_INTSTATUS_LLI_RD_DEC_ERR	(1ull<<9)
#define DMAC_CHX_INTSTATUS_LLI_WR_DEC_ERR	(1ull<<10)
#define DMAC_CHX_INTSTATUS_LLI_RD_SLV_ERR	(1ull<<11)
#define DMAC_CHX_INTSTATUS_LLI_WR_SLV_ERR	(1ull<<12)
#define DMAC_CHX_INTSIGNAL_BLOCK_TFR_DONE	(1ull<<0)
#define DMAC_CHX_INTSIGNAL_DMA_TFR_DONE		(1ull<<1)
#define DMAC_CHX_INTSIGNAL_SRC_TRANSCOMP	(1ull<<3)
#define DMAC_CHX_INTSIGNAL_DST_TRANSCOMP	(1ull<<4)
#define DMAC_CHX_INTSIGNAL_SRC_DEC_ERR		(1ull<<5)
#define DMAC_CHX_INTSIGNAL_DST_DEC_ERR		(1ull<<6)
#define DMAC_CHX_INTSIGNAL_SRC_SLV_ERR		(1ull<<7)
#define DMAC_CHX_INTSIGNAL_DST_SLV_ERR		(1ull<<8)
#define DMAC_CHX_INTSIGNAL_LLI_RD_DEC_ERR	(1ull<<9)
#define DMAC_CHX_INTSIGNAL_LLI_WR_DEC_ERR	(1ull<<10)
#define DMAC_CHX_INTSIGNAL_LLI_RD_SLV_ERR	(1ull<<11)
#define DMAC_CHX_INTSIGNAL_LLI_WR_SLV_ERR	(1ull<<12)
#define DMAC_CHX_INTCLEARREG_BLOCK_TFR_DONE	(1ull<<0)
#define DMAC_CHX_INTCLEARREG_DMA_TFR_DONE	(1ull<<1)
#define DMAC_CHX_INTCLEARREG_SRC_TRANSCOMP	(1ull<<3)
#define DMAC_CHX_INTCLEARREG_DST_TRANSCOMP	(1ull<<4)
#define DMAC_CHX_INTCLEARREG_SRC_DEC_ERR	(1ull<<5)
#define DMAC_CHX_INTCLEARREG_DST_DEC_ERR	(1ull<<6)
#define DMAC_CHX_INTCLEARREG_SRC_SLV_ERR	(1ull<<7)
#define DMAC_CHX_INTCLEARREG_DST_SLV_ERR	(1ull<<8)
#define DMAC_CHX_INTCLEARREG_LLI_RD_DEC_ERR	(1ull<<9)
#define DMAC_CHX_INTCLEARREG_LLI_WR_DEC_ERR	(1ull<<10)
#define DMAC_CHX_INTCLEARREG_LLI_RD_SLV_ERR	(1ull<<11)
#define DMAC_CHX_INTCLEARREG_LLI_WR_SLV_ERR	(1ull<<12)
